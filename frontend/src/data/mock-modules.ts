...
export const MOCK_MODULES: Module[] = [
  ...
  { id: 'mentor', code: 'MENTOR', name: 'Mentor', route: '/mentor', active: true, desc: 'Manage mentors and evaluations' },
  ...
  { id: 'college_coordinator', code: 'CC', name: 'College Coordinator', route: '/coordinator', active: true, desc: 'Portal for external coordinators' },
